...
const ShowSnackBarContext = createContext<TShowSnackBar>(
    (mes, sev) => console.log(mes, sev)
);

const ShowSnackBarProvider = ({ children, showSnackBar }: IShowSnackBarProvider) => {
    return (
