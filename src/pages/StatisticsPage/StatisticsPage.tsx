  ...
  return (
    <PageHeaderWrapper heightInPx={370}>
      <div className="w-full">
        ...
        >
          It's very helpful in analysing your efficiency to follow your
          statistics for different periods of time. Here you can choose what you
          want to track. For detail information choose corresponding way.
        </Typography>
