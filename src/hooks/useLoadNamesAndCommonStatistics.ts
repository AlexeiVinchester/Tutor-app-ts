...
type TUseLoadStatisticsInitialData = ({
  namesUrl,
  commonStatisticsUrl,
}: IUseLoadStatisticsInitialDataProps) => IUseLoadStatisticsInitialDataResult;

const useLoadStatisticsInitialData: TUseLoadStatisticsInitialData = ({
  namesUrl,
  commonStatisticsUrl,
}) => {
